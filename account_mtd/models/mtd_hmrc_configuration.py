...
class MtdHmrcConfiguration(models.Model):
    ...
    def get_access_token(self):
        """
        Access to the VAT Endpoints requires the Bearer token to be derived
        from an OAuth request. When the Endpoint request is being built,
        this method makes an OAuth request to get the token first, which
        is then used as part of the Endpoint request.
